...
export const mockParkingLots = [
  {
    ...
    longitude: -74.006,
    description:
      "Modern multi-level garage in the heart of downtown with 24/7 security and fast electric vehicle charging. Perfect for long-term and short-term parking with easy access to shops and restaurants.",
    photos: [
  ...
  },
  {
    ...
    longitude: -74.016,
    description:
      "Large open-air parking lot near the riverside with excellent rates and spacious spots. Well-lit and monitored with convenient payment options and mobile app booking.",
    photos: [
      "/placeholder.svg?height=400&width=600",
      "/placeholder.svg?height=400&width=600",
      "/placeholder.svg?height=400&width=600",
  ...
  },
  {
    ...
    longitude: -74.026,
    description:
      "Premium parking facility in the tech district with state-of-the-art security, climate-controlled spaces, and fast EV charging. Perfect for tech professionals with convenient access to major tech companies.",
    photos: [
      "/placeholder.svg?height=400&width=600",
      "/placeholder.svg?height=400&width=600",
      "/placeholder.svg?height=400&width=600",
  ...
  },
  {
    ...
    longitude: -74.036,
    description:
      "Prime waterfront street parking with scenic views and close proximity to restaurants and shops. Limited but highly sought-after spots in the heart of the waterfront district.",
    photos: [
      "/placeholder.svg?height=400&width=600",
      "/placeholder.svg?height=400&width=600",
      "/placeholder.svg?height=400&width=600",
    ...
    houseRules: ["2-hour time limit", "Meter required", "No weekend parking", "Validate parking ticket in shop"],
    dailyRate: 45,
  },
  {
    id: "5",
    ...
    longitude: -74.046,
    description:
      "Large shopping center parking with abundant spaces, clean facilities, and excellent customer service. Great for shopping trips with free first 30 minutes of parking for shoppers.",
    photos: [
      "/placeholder.svg?height=400&width=600",
      "/placeholder.svg?height=400&width=600",
      "/placeholder.svg?height=400&width=600",
  ...
  },
  {
    ...
    longitude: -74.056,
    description:
      "Exclusive parking facility for business professionals with reserved spots, valet service available, and proximity to major corporate offices. Premium amenities and white-glove service.",
    photos: [
      "/placeholder.svg?height=400&width=600",
      "/placeholder.svg?height=400&width=600",
      "/placeholder.svg?height=400&width=600",
...
export const mockFavorites = [
  { id: "1", name: "Downtown Plaza Garage", distance: 2.5, rating: 4.5 },
  { id: "2", name: "Riverside Lot", distance: 1.2, rating: 4.2 },
]
