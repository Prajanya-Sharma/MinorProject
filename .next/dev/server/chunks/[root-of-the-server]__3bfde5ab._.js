...
async function POST(request) {
    try {
        ...
        const { data: overlappingBookings, error: overlapError } = await supabase.from("bookings").select("*").eq("lot_id", lotId).eq("spot_number", spotNumber).neq("status", "cancelled").or(`and(start_date.lte.${endDate},end_date.gte.${startDate})`);
        if (overlapError) {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__3bfde5ab._.js.map