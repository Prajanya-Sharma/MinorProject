...
"[project]/app/api/lots/[id]/bookings/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function GET(request, { params }) {
    try {
        ...
        const { data: lot, error: lotError } = await supabase.from("parking_lots").select("user_id").eq("id", lotId).single();
        if (lotError || !lot) {
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
                error: "Lot not found"
            }, {
        ...
        const { data: bookings, error: bookingsError } = await supabase.from("bookings").select("*").eq("lot_id", lotId).order("start_date", {
            ascending: true
        });
        if (bookingsError) {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__46cbddec._.js.map